...
function handle_bitrate(msg) {
    console.log("BITRATE : ", msg.bitrate, logger.info.publisher_bitrate);
    
    logger.info.publisher_bitrate = msg.bitrate;
    logger.info.publisher_fps = msg.fps;
    logger.info.publisher_res = msg.res;
    logger.info.publisher_rtt = msg.rtt;
}

function reset_logger() {
    logger.info.publisher_bitrate = undefined;
    logger.info.publisher_fps = undefined;
    logger.info.publisher_res = undefined;
}
