...
do
    ...
    do
        ...
        # Virsh stats
        ./scripts/plot.py $i $indicator TIME VIRSH_ACTUAL,VIRSH_UNUSED,VIRSH_AVAILABLE,VIRSH_USABLE,VIRSH_SWAP_OUT,VM_MEMORY_USAGE,MEMORY_USED MEMORY_PRESSURE_AVG10
        # Viewer count
