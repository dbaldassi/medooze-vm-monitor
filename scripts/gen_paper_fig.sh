...
mkdir -p figures/progressive-reduction/cgroups/2_1
mkdir -p figures/progressive-reduction/cgroups/1_1
...
# pid regulation
mkdir -p figures/regulation/ballooning/2_1
mkdir -p figures/regulation/ballooning/1_1
...
$plot_exe $balloon_avg_file avg TIME VIRSH_AVAILABLE,VIRSH_USABLE,VIRSH_SWAP_OUT,MEMORY_USED MEMORY_PRESSURE_AVG10
move_files ballooning-simulcast-vp8 $root_wd/figures/progressive-reduction/ballooning

$plot_exe $balloon_avg_file,$max_avg_file,$reclaim_avg_file avg TIME PUBLISHER_BITRATE PUBLISHER_RTT
move_files . $root_wd/figures/progressive-reduction/all

$plot_exe $max_avg_file,$reclaim_avg_file avg TIME MEMORY_USED,MEMORY_MAX,SWAP MEMORY_PRESSURE_AVG10
move_files . $root_wd/figures/progressive-reduction/cgroups
...
$plot_exe $max_avg_file avg TIME MEMORY_USED,MEMORY_MAX,SWAP,VM_MEMORY_USAGE MEMORY_PRESSURE_AVG10 [320,450]
move_files $max_dir $root_wd/figures/viewer-burst/cgroups

$plot_exe $balloon_avg_file,$max_avg_file,$reclaim_avg_file avg TIME PUBLISHER_BITRATE PUBLISHER_RTT [320,450]
